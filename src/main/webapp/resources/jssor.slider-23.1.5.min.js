(function (i, g, c, h, e, k, f) {/*! Jssor */
    ...
    var b = i.$Jssor$ = new function () {
        ...
        function x(g, l) {
            ...
            function k(b, d, a) {
                var e = b.kb(p(-d / 2, -a / 2)), f = b.kb(p(d / 2, -a / 2)), g = b.kb(p(d / 2, a / 2)), h = b.kb(p(-d / 2, a / 2));
                b.kb(p(300, 300));
            ...
            x = function (e, c) {
                ...
                if (c.ef)if (d) wb(j.$CreateCallback(h, O, e, c)); else a(e, c)
            };
            j.ub = O;
            if (d) j.ub = x;
            if (e) j.ub = a; else if (!b) a = O;
            j.N = x;
            x(g, l)
        }
        ...
        j.Oc = function (c, d) {
            var a = c || {};
            if (c)if (b.Tc(c)) a = {fb: a}; else if (b.Tc(c.$Clip)) a.$Clip = {fb: c.$Clip};
            a.fb = a.fb || d;
        ...
        j.od = function (n, j, s, t, B, C, o) {
            ...
            if (n) {
                ...
                for (var i in j) {
                    ...
                    var x = c.floor(g);
                    if (g != x) g -= x;
                    var k = t.fb || d.$Linear, m, E = n[i], q = j[i];
                    if (b.jc(q)) {
                        k = t[i] || k;
                        var A = k(g);
                        m = E + q * A
    ...
    var l = function (B, E, g, M, P, K) {
        ...
        function L() {
            if (q) {
                var d = b.V(), e = c.min(d - C, g.hd), a = j + e * o;
                C = d;
                if (a * o >= n * o) a = n;
                u(a);
            ...
            z.Tb = function (d) {
                ...
                if (e || y) {
                    ...
                    b.$Each(j, function (a, e) {
                        ...
                        if (a.qd != d) {
                            if (!a.qd && !l) b.u(n[e]); else d == a.cf && l && b.R(n[e]);
                            a.qd = d;
                            b.N(n[e], a[d])
                        }
                    })
                    ...
                    if (I) {
                        ...
                        if (a.$Clip) {
                            ...
                            if (B && A) {
                                h.$Left = g.U / 2 * w;
                                h.$Right = -h.$Left
                            } else if (B) h.$Right = -g.U * w; else if (A) h.$Left = g.U * w
                        }
                        s.$Clip = u;
                        f.$Clip = g[t]
                    }
    ...
    var j = i.$JssorSlider$ = function (q, hc) {
        ...
        function Ec() {
            ...
            l.call(b, -1e8, 2e8);
            b.og = function () {
                var a = b.xb(), d = c.floor(a), f = v(d), e = a - c.floor(a);
                return {ob: f, mg: d, yb: e}
            };
            b.oc = function (d, b) {
                var f = c.floor(b);
                if (f != b && b > d) f++;
        ...
        function Cc() {
            ...
            l.call(a, -1, 2, {$Easing: d.$Linear, Xe: {yb: bc}, Cc: s}, b, {yb: 1}, {yb: -2});
            a.Nb = b
        }
        ...
        function Ac(i, f) {
            ...
            function ab(b) {
                if (b == S && r == f) {
                    if (!g) {
                        var a = h;
                        if (C)if (C.ob == f) a = C.ye(); else C.zb();
                        Y();
                        g = new yc(i, f, a, q);
                        g.Pc(p)
                    }
            ...
            function G(a, e, k) {
                if (a == f) {
                    ...
                    var j = c.min(f, a), i = c.max(f, a), n = c.min(i - j, j + s - i), m = w + o.$LazyLoading - 1;
                    (!R || n <= m) && d.Kb()
                }
            }
            ...
            function T(a, d, c, h) {
                ...
                b.$Each(i, function (f) {
                    ...
                    if (j == "caption") {
                        ...
                        if (i == "A") {
                            if (b.$AttributeEx(f, "u") == "image") n = b.Ef(f, "IMG"); else n = b.$FindChild(f, "image", e);
                            if (n) {
                                x = f;
                                b.eb(x, "block");
                                b.N(x, W);
        ...
        function yc(z, g, p, q) {
            var c = this, n = 0, v = 0, h, i, f, d, m, t, s, o = B[g];
            l.call(c, 0, 0);
            function w() {
                b.uc(K);
        ...
        function bc(c, b) {
            var a = y > 0 ? y : hb, d = Cb * b * (a & 1), e = Db * b * (a >> 1 & 1);
            Nb(c, d, e)
        }
        ...
        a.Yd = function (a) {
            var d = c.ceil(v(gb / dc)), b = v(a - P + d);
            if (b > w) {
        ...
        var rb = o.$BulletNavigatorOptions, X = o.$ArrowNavigatorOptions, bb = o.$ThumbnailNavigatorOptions, R = !o.$UISearchMode, z, t = b.$FindChild(q, "slides", R), db = b.$FindChild(q, "loading", R) || b.$CreateDiv(g), Lb = b.$FindChild(q, "navigator", R), ec = b.$FindChild(q, "arrowleft", R), cc = b.$FindChild(q, "arrowright", R), Jb = b.$FindChild(q, "thumbnavigator", R), pc = b.$CssWidth(t), oc = b.$CssHeight(t), W, U = [], xc = b.$Children(t);
        b.$Each(xc, function (a) {
            a.tagName == "DIV" && !b.$AttributeEx(a, "u") && U.push(a);
            b.A(a, (b.A(a) || 0) + 1)
        });
        var r = -1, P, ub, s = U.length, M = o.$SlideWidth || pc, L = o.$SlideHeight || oc, Yb = o.$SlideSpacing, Cb = M + Yb, Db = L + Yb, dc = hb & 1 ? Cb : Db, w = c.min(o.$Cols, s), ib, y, O, Bb, T = [], Tb, Vb, Rb, fc, Fc, u, kb = o.$AutoPlaySteps, E = o.$PauseOnHover, qc = o.$AutoPlayInterval, zb = o.$SlideDuration, sb, vb, gb, Ub = w < s, N = Ub ? o.$Loop : 0, Z, J, F = 1, Q, D, S, wb = 0, xb = 0, H, cb, fb, Fb, x, V, A, Wb = new sc, ab, Ob = [];
        if (s) {
            if (o.$HWA) Nb = function (a, c, d) {
                b.ub(a, {$TranslateX: c, $TranslateY: d})
            };
            u = o.$AutoPlay & 63;
            a.Ub = hc;
            mc();
            ...
            var B = [], C, K, Gb = b.$Device(), lb = Gb.Ge, G, qb, Mb, tb;
    ...
    i.$JssorCaptionSlideo$ = function (v, j, u, E) {
        ...
        function t(d, e) {
            ...
            b.$Each(c, function (c) {
                ...
                if (h) {
                    var d = b.$AttributeEx(c, "t"), g = p[b.cc(d)] || p[d], f = {$Elmt: c, Nc: g};
                    a.push(f)
                }
                a = a.concat(t(c, e + 1))
            });
        ...
        function z(t, u, g) {
            ...
            b.$Each(u, function (i) {
                ...
                var o = {$Easing: j, $OriginalWidth: g.U, $OriginalHeight: g.T}, k = new l(i.b, i.d, o, t, g, h);
                f = c.max(f, i.b + i.d);
                if (a) {
                    if (!d) d = new l(i.b, 0);
                    d.P(k)
        ...
        function i(k, d, e) {
            ...
            if (g > 4)for (var m = c.ceil(g / 4), a = 0; a < m; a++) {
                var h = d.slice(a * 4, c.min(a * 4 + 4, g)), j = new l(h[0].Y, 0);
                i(j, h, e);
                k.P(j)
        ...
        y(t(v, 1));
        i(m, g);
        var x = j.$Breaks || [], k = [].concat(x[b.cc(b.$AttributeEx(v, "b"))] || []);

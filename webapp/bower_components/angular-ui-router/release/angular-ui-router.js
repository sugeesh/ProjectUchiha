...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 * ```
	 *
	 * This example creates a bound version of a services function, and copies it to another object
	 * @example
	 * ```
	 *
	 * var SomeService = {
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 *
	 * The HookBuilder constructor is given the $transitions services and a Transition instance.  Thus, a HookBuilder
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 *
	 *  // inject services by name
	 *  // When a string is found, desugar creating a resolve that injects the named services
	...
	/**
	 * @internalapi A internal global services
	 *
...
/***/ function(module, exports, __webpack_require__) {
	...
	// $urlMatcherFactory services and $urlMatcherFactoryProvider
	...
	// $urlRouter services and $urlRouterProvider
	...
	// $state services and $stateProvider
	// $urlRouter services and $urlRouterProvider
	...
	// $transitions services and $transitionsProvider
	...
	/** Injectable services */
	/**
	 * An injectable services object which has the current state parameters
	 *
	 * This angular services (singleton object) holds the current state parameters.
	 ...
	 *   }
	 * };
	 * angular.services('SomeService', SomeService);
	 * ```
	 *
	 * ### Deprecation warning:
	 *
	 * When `$stateParams` is injected into transition hooks, resolves and view controllers, they receive a different
	 * object than this global services object.  In those cases, the injected object has the parameter values for the
	 * *pending* Transition.
	 *
	 * Because of these confusing details, this services is deprecated.
	 *
	...
	var $stateParams;
	/**
	 * An injectable services primarily used to register transition hooks
	 *
	 * This angular services exposes the [[TransitionService]] singleton, which is primarily used to add transition hooks.
	 *
	...
	/**
	 * An injectable services used to query for current state information.
	 *
	 * This angular services exposes the [[StateService]] singleton.
	 */
	var $state;
	/**
	 * A config-time injectable provider used to register states.
	 *
	 * This angular services exposes the [[StateProvider]] singleton.
	 */
	var $stateProvider;
	/**
	 * A config-time injectable provider used to manage the URL.
	 *
	 * This angular services exposes the [[UrlRouterProvider]] singleton.
	 */
	var $urlRouterProvider;
	/**
	 * An injectable services used to configure URL redirects.
	 *
	 * This angular services exposes the [[UrlRouter]] singleton.
	 */
	var $urlRouter;
	/**
	 * An injectable services used to configure the URL.
	 *
	 * This services is used to set url mapping options, and create [[UrlMatcher]] objects.
	 *
	 * This angular services exposes the [[UrlMatcherFactory]] singleton.
	 ...
	 * This services is used to set url mapping options, and create [[UrlMatcher]] objects.
	 *
	 * This angular services exposes the [[UrlMatcherFactory]] singleton at config-time.
...
/***/ function(module, exports, __webpack_require__) {
	...
	var stateBuilder_1 = __webpack_require__(40);
	/**
	 * Implementation of the legacy `$resolve` services for angular 1.
	 */
	var $resolve = {
	    /**
	     * Asynchronously injects a resolve block.
	     *
	     * This emulates most of the behavior of the ui-router 0.2.x $resolve.resolve() services API.
	     *
	        ...
	        compile: function (tElement) {
	            ...
	            return function (scope, $element) {
	                ...
	                if (controller) {
	                    ...
	                    // TODO: Use $view services as a central point for registering component-level hooks
	                    // Then, when a component is created, tell the $view services, so it can invoke hooks

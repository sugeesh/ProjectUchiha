 ...
 * @param injector (for ng1 or ng2 only) the injector services
 *
...
export interface IHookRegistry {
     ...
     * performing tasks when entering a submodule/feature area such as initializing a stateful services,
     ...
     * #### Audit Log
     *
     * This example uses a services to log that a user has entered the admin section of an app.
     ...
     * performing tasks when leaving a submodule/feature area such as cleaning up a stateful services,
